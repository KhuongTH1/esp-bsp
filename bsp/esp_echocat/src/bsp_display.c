...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_panel_reset(ret_handles->panel), err, TAG, "LCD reset failed");
    ESP_GOTO_ON_ERROR(esp_lcd_panel_init(ret_handles->panel), err, TAG, "LCD init failed");
    ESP_GOTO_ON_ERROR(esp_lcd_panel_invert_color(ret_handles->panel, true), err, TAG, "LCD invert failed");
    ESP_GOTO_ON_ERROR(esp_lcd_panel_swap_xy(ret_handles->panel, false), err, TAG, "LCD swap XY failed");
    ESP_GOTO_ON_ERROR(esp_lcd_panel_mirror(ret_handles->panel, false, false), err, TAG, "LCD mirror failed");
