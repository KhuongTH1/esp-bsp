...
#define BSP_POWER_AMP_IO     (GPIO_NUM_18)
#define BSP_SPEAKER_EN       (BSP_POWER_AMP_IO)
#define BSP_MIC_EN           (GPIO_NUM_NC)
/** @} */ // end of audio
 ...
 *  @{
 */
#define BSP_LCD_PCLK         (GPIO_NUM_8)
 ...
 *  @{
 */
#define BSP_BUTTON_1_CH      (6)
#define BSP_BUTTON_2_CH      (7)
/** @} */ // end of buttons
 ...
 *  @{
 */
#define BSP_LED_1_IO         (GPIO_NUM_46)
/** @} */ // end of led
