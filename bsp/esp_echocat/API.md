...
| :1234: [CAPABILITIES](#1234-capabilities) | :floppy_disk: [SD CARD AND SPIFFS](#floppy_disk-sd-card-and-spiffs) | :musical_note: [AUDIO](#musical_note-audio) | :pager: [DISPLAY AND TOUCH](#pager-display-and-touch) | :radio_button: [BUTTONS](#radio_button-buttons) | :bulb: [LEDS](#bulb-leds) | 
| :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | :-------------------------: | 
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BOARD\_ESP\_ECHOCAT**](#define-bsp_board_esp_echocat)  <br> |
...
| define  | [**BSP\_I2C\_SCL**](#define-bsp_i2c_scl)  (GPIO\_NUM\_1)<br> |
| define  | [**BSP\_I2C\_SDA**](#define-bsp_i2c_sda)  (GPIO\_NUM\_2)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_SD\_CLK**](#define-bsp_sd_clk)  (GPIO\_NUM\_16)<br> |
| define  | [**BSP\_SD\_CMD**](#define-bsp_sd_cmd)  (GPIO\_NUM\_38)<br> |
| define  | [**BSP\_SD\_D0**](#define-bsp_sd_d0)  (GPIO\_NUM\_17)<br> |
...
| define  | [**BSP\_SD\_EN**](#define-bsp_sd_en)  (GPIO\_NUM\_9)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_I2S\_DOUT**](#define-bsp_i2s_dout)  (GPIO\_NUM\_41)<br> |
| define  | [**BSP\_I2S\_DSIN**](#define-bsp_i2s_dsin)  (GPIO\_NUM\_3)<br> |
| define  | [**BSP\_I2S\_LCLK**](#define-bsp_i2s_lclk)  (GPIO\_NUM\_39)<br> |
| define  | [**BSP\_I2S\_MCLK**](#define-bsp_i2s_mclk)  (GPIO\_NUM\_42)<br> |
| define  | [**BSP\_I2S\_SCLK**](#define-bsp_i2s_sclk)  (GPIO\_NUM\_40)<br> |
| define  | [**BSP\_MIC\_EN**](#define-bsp_mic_en)  (GPIO\_NUM\_48)<br> |
| define  | [**BSP\_POWER\_AMP\_IO**](#define-bsp_power_amp_io)  (GPIO\_NUM\_15)<br> |
| define  | [**BSP\_SPEAKER\_EN**](#define-bsp_speaker_en)  (GPIO\_NUM\_48)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LCD\_BACKLIGHT**](#define-bsp_lcd_backlight)  (GPIO\_NUM\_44)<br> |
...
| define  | [**BSP\_LCD\_DATA0**](#define-bsp_lcd_data0)  (GPIO\_NUM\_46)<br> |
| define  | [**BSP\_LCD\_DATA1**](#define-bsp_lcd_data1)  (GPIO\_NUM\_13)<br> |
| define  | [**BSP\_LCD\_DATA2**](#define-bsp_lcd_data2)  (GPIO\_NUM\_11)<br> |
| define  | [**BSP\_LCD\_DATA3**](#define-bsp_lcd_data3)  (GPIO\_NUM\_12)<br> |
| define  | [**BSP\_LCD\_DC**](#define-bsp_lcd_dc)  (GPIO\_NUM\_45)<br> |
| define  | [**BSP\_LCD\_EN**](#define-bsp_lcd_en)  (GPIO\_NUM\_9)<br> |
| define  | [**BSP\_LCD\_H\_RES**](#define-bsp_lcd_h_res)  (360)<br> |
...
| define  | [**BSP\_LCD\_RST**](#define-bsp_lcd_rst)  (GPIO\_NUM\_47)<br> |
| define  | [**BSP\_LCD\_SPI\_NUM**](#define-bsp_lcd_spi_num)  (SPI2\_HOST)<br> |
| define  | [**BSP\_LCD\_TOUCH\_INT**](#define-bsp_lcd_touch_int)  (GPIO\_NUM\_10)<br> |
| define  | [**BSP\_LCD\_V\_RES**](#define-bsp_lcd_v_res)  (360)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_BUTTON\_1\_CH**](#define-bsp_button_1_ch)  (6)<br> |
| define  | [**BSP\_BUTTON\_2\_CH**](#define-bsp_button_2_ch)  (7)<br> |
...
| Type | Name |
| ---: | :--- |
| define  | [**BSP\_LED\_1\_IO**](#define-bsp_led_1_io)  (GPIO\_NUM\_43)<br> |
